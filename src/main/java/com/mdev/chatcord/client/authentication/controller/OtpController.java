...
public class OtpController extends DragWindow implements EventStageHandler, UIErrorHandler {
    ...
    @FXML
    private TextFlow textFlow, successTextFlow;
    @FXML
    private HBox backgroundHBox;
    @FXML
    private Label toEmail, headerLabel, subHeaderLabel, resendLabel;
    @FXML
    private TextField num0, num1, num2, num3, num4, num5;
    @FXML
    ...
    public void onResendLinkClicked() {
        num0.requestFocus();
        try {
            authenticationService.resendOtp(toEmail.getText());
        } catch (BusinessException e) {
    ...
    private void startCountdown() {
        try {
            secondsRemaining = authenticationService.canResendOtp(toEmail.getText());
