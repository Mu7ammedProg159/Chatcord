package com.mdev.chatcord.client.authentication.controller;
...
import com.mdev.chatcord.client.common.controller.LoadingController;
import com.mdev.chatcord.client.exception.BusinessException;
import com.mdev.chatcord.client.common.implementation.LoadingHandler;
import com.mdev.chatcord.client.common.implementation.ThrowingRunnable;
import com.mdev.chatcord.client.authentication.enums.ELoginStatus;
...
public class LoginController implements LoadingHandler, UIHandler {
    ...
    public void updateMode() {
        if (isRegisterMode) {
            ...
            showFields(true, usernameField, confirmPasswordField, usernameVBox, confirmPasswordVBox);
            ...
            showFields(false, usernameField, confirmPasswordField, usernameVBox, confirmPasswordVBox);
    ...
    private void showFields(boolean b, Node... nodes) {
        for (Node node: nodes) {
            node.setVisible(b);
            node.setManaged(b);
        }
    ...
    public void onSubmitClicked() throws IOException {
        ...
        if (isRegisterMode) {
            ...
            try {
                String registerResponse = authenticationService.register(email, password, username);
                ...
                Platform.runLater(() -> {
                    ...
                    setError(emailLabel, "EMAIL ADDRESS – " + e.getMessage()
